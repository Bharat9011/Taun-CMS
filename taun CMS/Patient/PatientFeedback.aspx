<%@ Page Title="Feedback" Language="C#" MasterPageFile="~/Patient/PatientMaster.Master" AutoEventWireup="true" CodeBehind="PatientFeedback.aspx.cs" Inherits="taun_CMS.Patient.PatientFeedback" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="margin-left: 70px">
        ...
        <div style="margin-left: 790px">
            ...
            <asp:Button ID="button1" runat="server" Visible="false" Text="Give Feedback" Font-Bold="true" />
