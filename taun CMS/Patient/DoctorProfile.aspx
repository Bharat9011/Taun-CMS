<%@ Page Title="Doctor's Profile" Language="C#" MasterPageFile="~/Patient/PatientMaster.Master" AutoEventWireup="true" CodeBehind="DoctorProfile.aspx.cs" Inherits="taun_CMS.Patient.DoctorProfile" %>
